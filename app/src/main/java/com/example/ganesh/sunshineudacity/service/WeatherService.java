package com.example.ganesh.sunshineudacity.service;
...
import com.example.ganesh.sunshineudacity.Utility;
...
/**
 * Created by Ganesh Prasad on 02-07-2016.
 */
public class WeatherService extends IntentService {

    private static final String LOG_TAG = "Service Activity";
    public static final String LOCATION_QUERY = "lqe";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.v("Fetch task" , locationQuery);
        ...
        String units = "metric";
        int numDays = 14;
        String appid = "fde6e9891517ea4889424fe0a4b6c8ee";
